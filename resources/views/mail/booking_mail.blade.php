...
<body>
    <div class="bee-page-container">
        ...
        <div class="bee-row bee-row-3">
            <div class="bee-row-content" style="display: flex; align-items: center;">
                <!-- Spacer trái -->
                ...
                <!-- Nội dung chính -->
                <div class="bee-col bee-col-2 bee-col-w5" style="padding: 20px;">
                    <div class="bee-block bee-block-1 bee-spacer">
                    ...
                    margin: 0 0 20px 0;
                    line-height: 1.6;">
                            Đặt lịch sửa xe chuyên nghiệp, nhanh chóng và dễ dàng.<br>
                            Phục vụ tận tâm - Đúng giờ - Chất lượng cao.
                        </p>
                    </div>


                    <div class="bee-block bee-block-4 bee-button">
                        <a class="bee-button-content" href="{{ route('homepage') }}"
                            style="
                       font-size: 14px;
            ...
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w8">
                    <div class="bee-block bee-block-1 bee-paragraph">
                        ...
                        <p>Yêu cầu đặt lịch của bạn đã được <strong>{{ $booking->status }}</strong> với thông tin như
                            sau:</p>

                        <ul>
                            <li><strong>Ngày:</strong> {{ $dateBooking }}</li>
                            Thời gian đặt lịch:
                            <strong>{{ \Carbon\Carbon::parse($dateBooking)->format('d/m/Y') }}</strong><br>
                            Giờ: <strong>{{ $startTime }} - {{ $endTime }}</strong>
                            <li><strong>Dịch vụ:</strong> {{ $booking->service->service_name }}</li>
                            <li><strong>Email:</strong> {{ $booking->customer->customer_email }}</li>
                            <li><strong>Ghi chú:</strong> {{ $booking->note ?? 'Không có' }}</li>
                        </ul>


                        <p>Chúng tôi rất vui khi được đồng hành cùng bạn trong quá trình bảo dưỡng và sửa chữa xe. Yêu
                            cầu đặt lịch của bạn đã được tiếp nhận thành công, và kỹ thuật viên sẽ sẵn sàng phục vụ vào
                            khung giờ bạn đã chọn. </p>

                        <p> Chúng tôi sẽ giữ chỗ cho bạn trong 10 phút, sẽ không sao nếu bạn không đến được, đừng lo lắng nhé.</p>

                        <p>Nếu bạn cần thay đổi thời gian hoặc có bất kỳ thắc mắc nào, xin vui lòng liên hệ với chúng
                            tôi qua email hoặc số điện thoại hỗ trợ. Chúng tôi luôn sẵn sàng hỗ trợ bạn một cách nhanh
                            chóng và tận tâm.</p>
                    ...
                    <div class="bee-block bee-block-2 bee-button"><a class="bee-button-content"
                            ...
                            target="_self"><span dir="ltr"
                                style="word-break: break-word; font-size: 14px; line-height: 200%; letter-spacing: 1px;">Xem
                                thêm..</span></a></div>
                </div>
                        ...
                        <div class="bee-icon bee-icon-last">
                            <div class="bee-content">
                                <div class="bee-icon-image"><a href="https://www.designedwithbee.com/"
                                        target="_blank" title="Designed with Kane"><img alt="Designed with Kane"
                                ...
                                <div class="bee-icon-label bee-icon-label-right"><a
                                        ...
                                        title="Designed with BEE">Designed with Kane Nguyen</a></div>
                            </div>
                        </div>
                    </div>
                </div>
