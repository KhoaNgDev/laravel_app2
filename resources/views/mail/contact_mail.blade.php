        ...
        <div class="bee-row bee-row-3">
            <div class="bee-row-content" style="display: flex; align-items: center;">
                ...
                <div class="bee-col bee-col-2 bee-col-w5" style="padding: 20px;">
                    ...
                    text-align: left;
                    margin: 0 0 10px 0;">
                           Dịch vụ sửa chữa xe chuyên nghiệp
                        </h1>
                    </div>
                    ...
                    <div class="bee-block bee-block-4 bee-button">
                        <a class="bee-button-content" href="{{ route('booking') }}"
                            style="
                       font-size: 14px;
        ...
        <div class="bee-row bee-row-5">
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w8">
                    <div class="bee-block bee-block-1 bee-paragraph">
                        <p>Cảm ơn bạn đã liên hệ với chúng tôi! Chúng tôi đã nhận được phản hồi với thông tin như sau:
                        </p>

                        <ul>
                            <li><strong>Họ tên:</strong> {{ $testimonial->name }}</li>
                            <li><strong>Email:</strong> {{ $testimonial->email }}</li>
                            <li><strong>Số điện thoại:</strong> {{ $testimonial->phone }}</li>
                            <li><strong>Đánh giá:</strong> {{ $testimonial->rating }} ⭐</li>
                            <li><strong>Nội dung góp ý:</strong> {{ $testimonial->message }}</li>
                        </ul>

                        <p>Chúng tôi rất trân trọng ý kiến của bạn và sẽ phản hồi sớm nhất có thể.
                            Đội ngũ kỹ thuật viên của chúng tôi luôn sẵn sàng hỗ trợ bạn một cách tận tâm và chuyên
                            nghiệp.</p>

                        <p>Trân trọng,<br>Đội ngũ hỗ trợ khách hàng Repairs Services</p>
                    </div>
                    ...
                    <div class="bee-block bee-block-2 bee-button"><a class="bee-button-content"
                            ...
                            target="_self"><span dir="ltr"
                                style="word-break: break-word; font-size: 14px; line-height: 200%; letter-spacing: 1px;">Xem thêm</span></a></div>
                </div>
